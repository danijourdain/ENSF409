...
public class PlayTheGame{
    public static void main(String[] args) throws IllegalArgumentException, SingleUseMethodException{
        ...
        /*
        System.out.println("CHECKING PLAIN TEXT");
        PrintPlaintext plain = new PrintPlaintext();
        plain.printMessage("Hi");
        plain.printFightLog(outcome);
        plain.printStats(char1);

        System.out.println("CHECKING HTML");
        PrintHTML html = new PrintHTML();
        html.printMessage("Hi");
        html.printFightLog(outcome);
        html.printStats(char1);
        */
    }
