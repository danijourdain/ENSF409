...
public class AroundTheWorld {
    public static void main(String args[]) {
        ...
        System.out.println();
	array[2].setDeparture("2023-01-10");
	array[2].setArrival("2023-01-10");
	System.out.println("--" + array[2].getArrival() + "--");
	System.out.println("--" + array[2].getDeparture() + "--");
	System.out.println("--" + array[2].getCity() + "--");
	System.out.println("--" + array[2].getCountry() + "--");
    ...
    public static String[][] example2() {
       String[][] example = {
         { "2022-12-15", "2021-12-31", "Nuuk", "Greenland" },
   ...
   public static String[][] example3() {
      String[][] example = {
         {"2021-11-01", "2021-11-26", "Calgary", "Canada"},
         {"2022-09-01", "2022-09-15", "Los Angeles", "USA"},
         {"2023-01-10", "2023-01-22", "London", "England"}
      };
      return example;
   }
}