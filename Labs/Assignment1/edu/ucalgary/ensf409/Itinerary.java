...
public class Itinerary {
    ...
    public String formatByArrival() {
        ...
        int firstYear = trips[0].getYear(trips[0].getArrival());
        //firstYear is the year of the first trip in the list
    ...
    public String[][][] byDate() {
        ...
        /* SHOULD BE [3][12][20] INSTEAD */
        //dimensions of locations are for 3 possible years, 12 possible months,
            // and 1 possible string in each
        ...
        for(Trip value: trips) {
            ...
            //find the arrival year and month using getter methods
    ...
    /*
    String[][][] byDate2() {
        String[][][] ordered = new String[3][12][20];
        ...
        for(Trip trip: this.trips) {
            ...
            int y = trip.getYear(trip.getArrival());
            int i = 0;
            if(y == 2022) {
                i = 1;
            }
            ...
            int m = trip.getMonth(trip.getArrival()) - 1;
